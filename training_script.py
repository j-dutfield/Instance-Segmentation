...
# INIT Mask RCNN in training mode
new_model = modellib.MaskRCNN(mode="training", model_dir='mask_rcnn_coco.py', config=_config)
#load pretrained weights
new_model.load_weights(ROOT_DIR+"/samples/mask_rcnn_coco.h5", by_name=True, exclude=[
        "mrcnn_class_logits", "mrcnn_bbox_fc",
        "mrcnn_bbox", "mrcnn_mask"])
new_model.train(dataset,val_dataset,learning_rate=0.001,epochs=1,layers='heads')

print("training complete")
print("weights should be saved automatically into coco folder in h5 format")